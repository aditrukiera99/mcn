...
class Penawaran_barang_beli_m extends CI_Model
{
                              ...
                              $total_all, $sts_lunas, $memo_lunas, $akun_piutang, $kode_akun_pajak, $unit)
    {
        ...
        (ID_KLIEN, NO_BUKTI, ID_PELANGGAN, PELANGGAN, ALAMAT, TGL_TRX, TGL_JATUH_TEMPO, ID_PAJAK, SUB_TOTAL, NILAI_PAJAK, TOTAL, LUNAS, MEMO, KODE_AKUN_PAJAK, UNIT, TIPE)
        VALUES 
        ($id_klien, '$no_trx', $id_pelanggan, '$pelanggan', '$alamat_tagih', '$tgl_trx', '$tgl_jatuh_tempo', '$id_pajak', '$sub_total', '$pajak_total', '$total_all', '$sts_lunas', '$memo_lunas', '$kode_akun_pajak', '$unit', 'PENAWARAN_BELI')
        ";
