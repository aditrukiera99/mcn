...
class Lap_servis_farmasi_m extends CI_Model
{
    ...
    function get_lap_penjualan($id_klien, $tgl_awal, $tgl_akhir, $unit){
        $sql = "      
        SELECT a.TGL_TRX, a.JATUH_TEMPO, a.NO_BUKTI, a.NO_DO, a.NO_POL, a.BROKER, a.PELANGGAN, a.ALAMAT_TUJUAN, b.QTY, b.MODAL, b.HARGA_JUAL, b.HARGA_INVOICE, b.PAJAK, b.CASHBACK, b.PROFIT, c.SATUAN
