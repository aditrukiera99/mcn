...
<td style="vertical-align: top; width: 50%;"><?=$dt->TGL_DO;?></td>
...
<p>
</p><table style="border-collapse: collapse; width: 100%; text-align: left; margin-left: auto; margin-right: auto;" border="3" cellpadding="0" cellspacing="0">
	...
	<col style="width: 83pt;" width="111"> 
		...
		<tr style="height: 15pt;" height="20">
			...
			<td class="xl66" style="border-top: medium none; border-left: medium none; text-align: center; width: 127px;"><?=str_replace(',', '.', number_format($dt_det->QTY));?><br></td>
			<td colspan="2" class="xl67" style="border-left: medium none; vertical-align: top;"><br>No. Atas : <?=$dt->SEGEL_ATAS;?><br>
			No. Bawah : <?=$dt->SEGEL_BAWAH;?>			
			</td>
		</tr>
		<tr style="height: 15pt;" height="20">
