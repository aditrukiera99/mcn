...
<table style="text-align: left; width: 100%;" border="0" cellpadding="0" cellspacing="0">
	<tbody>
		...
		<tr>
			...
			<td style="vertical-align: top; width: 935px;"><?=$dt->PELANGGAN;?>		</td>
		</tr>
		<tr>
			<td style="vertical-align: top; width: 111px;"><br>
			</td>
			...
			<td style="vertical-align: top; width: 935px;"><?=$dt->ALAMAT_TUJUAN;?>		</td>
		</tr>
	</tbody>
</table>
...
<font size="3">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td style="padding-top:20px; vertical-align: top; text-align: center;"><?=str_replace(',', '.', number_format($dt_det->QTY));?>      </td>
      <td style="padding-top:20px; padding-right: 20px; vertical-align: top; text-align: right"><?=number_format($harga_satuan, 2, ',', '.');?> <br>
	  
	  
	    <?PHP if($dt_det->PAJAK == "PPN"){ ?>
	    <span style="padding-right: 4px;"><?=number_format($harga_satuan2, 2, ',', '.');?></span>	   
      <?PHP } ?>
      </td>
      <td style="padding-top:20px; padding-right: 20px; vertical-align: top; text-align: right">
         <?=number_format($harga_satuan*$dt_det->QTY, 2, ',', '.');?>
	       <?PHP if($dt_det->PAJAK == "PPN"){ ?>
         <?=number_format($harga_satuan2*$dt_det->QTY, 2, ',', '.');?>   
         <?PHP } ?>
      </td>
    </tr>
    <tr>
      ...
      <td style="vertical-align: top; text-align: center;"><?=str_replace(',', '.', number_format($dt_det->QTY));?>     </td>
      <td style="vertical-align: top; text-align: right; padding-right: 20px;"> 
        <?=number_format($dt_det->HARGA_INVOICE, 2, ',', '.');?>   	      
      </td>
      <td style="vertical-align: top; text-align: right; padding-right: 20px;">
        <font size="3"><strong><span style="text-decoration: underline;"><?=number_format($dt_det->HARGA_INVOICE * $dt_det->QTY, 2, ',', '.');?>        </span></strong></font>
      </td>
    </tr>
    <tr>
      <td colspan="5" rowspan="1" style="vertical-align: top; width: 87px;">Terbilang : <font size="3"><i><b> <?PHP echo terbilang($dt_det->HARGA_INVOICE * $dt_det->QTY, $style=3); ?> Rupiah</b></i></font>
      <br>
      <br>
      <br>
      <br>
    ...
    <tr>
      ...
      <table style="text-align: left; width: 100%;" border="0" cellpadding="0" cellspacing="0">
        <tbody>
          <tr>
            <td style="vertical-align: top; width: 562px;"><b>No. Rekening :</b><br>
			 1. Bank BCA 0893799777  - PT Mitra Central Niaga, Pasuruan <br>2. Bank Mandiri 1440077799937 - PT. Mitra Central Niaga, Pasuruan<br>			
            ...
            <td style="vertical-align: top; width: 369px; text-align: center;">Pasuruan, <?PHP echo date("d F Y",strtotime($dt->TGL_INV)); ?><br>
            <br>
            <br>
            <br>
            <br>
