...
<table align="center">
    <tr>
        <td align="center">
            ...
            <label>NO : 001/DO/MCN.PAS/II/2018</label>
        </td>
    </tr>
</table>
<br>
...
<div style="width: 100%;padding-top: 10px;padding-bottom: 10px;padding-left:5px;">
	<table style="width: 100%;">
		<tr>
			<td style="width: 20%;text-align:left;font-size: 15px;">Pembeli</td>
			<td style="width: 80%;text-align:left;font-size: 15px;">: CV. MUTIARA TIMUR</td>
		</tr>
		<tr>
		...
		<tr>
			<td style="width: 20%;text-align:left;font-size: 15px;">Tujuan </td>
			<td style="width: 80%;text-align:left;font-size: 15px;">: CV. MUTIARA TIMUR </td>
		</tr>
		<tr>
			<td style="width: 20%;text-align:left;font-size: 15px;"> </td>
			<td style="width: 80%;text-align:left;font-size: 15px;"> &nbsp; Ds. Kunjorowesi, Kec. Ngoro</td>
		</tr>
		<tr>
			<td style="width: 20%;text-align:left;font-size: 15px;"> </td>
			<td style="width: 80%;text-align:left;font-size: 15px;"> &nbsp; Mojokerto</td>
		</tr>

		<tr>
			<td style="width: 20%;text-align:left;font-size: 15px;">Tanggal </td>
			<td style="width: 80%;text-align:left;font-size: 15px;">: 12 Februari 2018</td>
		</tr>
		<tr>
			<td style="width: 20%;text-align:left;font-size: 15px;">No. PO </td>
			<td style="width: 80%;text-align:left;font-size: 15px;">:</td>
		</tr>
...
<?PHP
    ...
    $html2pdf->pdf->SetTitle('Cetak Delivery Order');
    $html2pdf->WriteHTML($content, isset($_GET['vuehtml']));
    $html2pdf->Output('cetak_delivery_order.pdf');
?>