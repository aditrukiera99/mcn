						...
						<?PHP  foreach ($dt as $key => $row) { ?>
							...
							<tr>
								<td align="center">
									...
									<a target="blank" href="<?=base_url();?>penawaran_barang_c/cetak/<?=$row->ID;?>" class="btn btn-info" type="button" style="font-size: 15px; padding-right: 8px;"><i class="icon-print"></i></button>
								</td>
