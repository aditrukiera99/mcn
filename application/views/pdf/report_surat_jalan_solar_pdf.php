...
<img style="width: 100%; height: 10%;" alt="" src="<?=$base_url2;?>assets/img/header.png">
</div>
<br>
...
<tbody>
	...
	<tr>
		...
		<td style="vertical-align: top; width: 322px;"><?=$dt->PELANGGAN;?>	
		</td>
	</tr>
	<tr>
		...
		<td style="vertical-align: top;"><?=$dt->ALAMAT_TUJUAN;?>	
		</td>
	</tr>
	</tbody>
</table>
<table style="border-collapse: collapse; width: 100%; text-align: left; margin-left: auto; margin-right: auto;" border="4" cellpadding="3" cellspacing="">
	...
	<tr style="height: 10pt;" height="32">
		...
		<td colspan="2" rowspan="2" class="xl66" style="width: 36%;">
			<table style="text-align: left; width: 100%; margin-left: auto; margin-right: auto;" border="0" cellpadding="1" cellspacing="0">
				<tbody>
				<tr>
					...
					<td style="vertical-align: top; width: 38%;"><?=$dt->TGL_SJ;?>				<br>
					</td>
				</tr>
				<tr>
    ...
    <tr style="height: 60pt;" height="10">
		<td class="xl65" style="border-top: medium none; height: 15pt; width: 167px; text-align: center;" height="15"><?=$dt_det->NAMA_PRODUK;?></td>
		<td class="xl66" style="border-top: medium none; border-left: medium none; text-align: center; width: 89px;"><?=str_replace(',', '.', number_format($dt_det->QTY));?></td>
